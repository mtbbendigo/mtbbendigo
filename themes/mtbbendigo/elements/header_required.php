...
/**
 * Author: Gareth Baker
 * This file has been copied from dir concrete/elements/
 * The purpose of putting it here is to speed up load time.
 * By default concrete5 adds its own style sheets and jquery files into the <head> elements.
 * By overriding this file here, the extra elements will only be loaded when the user is logged on
 * therefore providing the required files for the pop-up windows used by Administrators.
 * In case this site is hacked the required files will be active only for a registered user.
 * See line 100 for changes.
 */
...
{
	//As per comments above, only load these files for Registered Users.
