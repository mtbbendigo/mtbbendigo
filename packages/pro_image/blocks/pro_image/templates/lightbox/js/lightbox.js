...
(function() {
  ...
  LightboxOptions = (function() {
    ...
    function LightboxOptions() {
      this.fileLoadingImage = 'http://icons.iconarchive.com/icons/fatcow/farm-fresh/32/time-icon.png';
      this.fileCloseImage = 'http://icons.iconarchive.com/icons/deleket/button/32/Button-Close-icon.png';
