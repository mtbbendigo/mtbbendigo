...
class MtbImageBlockController extends BlockController {
	
	protected $btName = 'MTB Image';
	protected $btDescription = 'A block that wraps the image with the standard mtbbendigo image border css, hyperlink is optional.';
	protected $btTable = 'btDCMtbImage';
