...
class OrbitImageRotatorBlockController extends BlockController {
	
	protected $btName = 'Orbit Image Rotator';
	protected $btDescription = 'Image rotator, accepts up to five images.';
	protected $btTable = 'btDCOrbitImageRotator';
