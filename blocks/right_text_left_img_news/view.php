	...
	<?php  if (!empty($field_1_textbox_text)): ?>
		<?php echo '<div class="row">'; ?>
			<?php echo '<div class="large-12 columns">';?>
				<?php echo '<div class="news-article-title"><h2>';?>
		...
		<div class="large-4 columns">
			<?php  if (!empty($field_2_image)): ?>
				<?php echo '<div class="article-image-container">';?>
					...
					<a href="<?php  echo $nh->getLinkToCollection(Page::getByID($field_2_image_internalLinkCID), true); ?>"><?php  } ?>
		...
		<?php  if (!empty($field_3_image)): ?>
			<?php echo '<div class="article-image-container">';?>
				<?php  if (!empty($field_3_image_externalLinkURL)) { ?>
					...
					<img src="<?php  echo $field_3_image->src; ?>" width="<?php  echo $field_3_image->width; ?>" height="<?php  echo $field_3_image->height; ?>" alt="" style="border: 4px solid white; -moz-box-shadow: 0 0 8px #888; -webkit-box-shadow: 0 0 8px #888; -o-box-shadow: 0 0 8px #888; box-shadow: 0 0 8px #888;" />
