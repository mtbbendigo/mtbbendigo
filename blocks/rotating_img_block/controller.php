...
class RotatingImgBlockBlockController extends BlockController {
	
	protected $btName = 'Rotating Image Block';
	protected $btDescription = 'Add up to three images that will rotate periodically. This rotator uses Orbit (packaged with Foundationzurb) and has an image border applied.';
	protected $btTable = 'btDCRotatingImgBlock';
